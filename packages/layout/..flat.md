...
:root {
  /* --- Curve Variables --- */
  --tab-curve-size: 10px; /* Adjust the curve radius here */
  --tab-border-width: 1px; /* MUST match tab bar's border-bottom-width */
  /* --- End Curve Variables --- */
  ...
  /* font-family: var(--font-sans); <-- REMOVED TO PREVENT OVERRIDE */
  color: var(--foreground);
  background-color: var(--background);
}

/* --- Minimal Reset (Keep only essentials if needed) --- */
*,
::before,
::after {
  ...
  border-color: var(
    --border,
    #e5e7eb
  ); /* Use your border variable or a fallback */
}
...
:host {
  ...
  -o-tab-size: 4;
  tab-size: 4;
  /* REMOVED font-family: ui-sans-serif... */
...
body {
  margin: 0;
  line-height: inherit;
  /* Ensure body inherits application font */
  font-family: var(--font-sans); /* Or your specific font variable */
}
...
.flexlayout__layout {
  ...
  /* font-family: var(--font-sans); <-- Let body handle this */
  color: var(--foreground);
  background-color: var(--background);
}
...
.flexlayout__layout
  ...
  padding-left: 40px; /* Keep if this is specific layout padding */
  gap: 1px;
}
...
.flexlayout__tabset {
  ...
  color: var(--foreground);
  box-sizing: border-box;
  /* font-family: inherit; <-- Let body/layout handle */
  overflow: hidden;
  flex-grow: 1;
}
...
.flexlayout__tabset_container {
  ...
  overflow: hidden;
  flex-grow: 1;
  background-color: var(--background); /* Match content background for curves */
  padding: 0;
}
...
.flexlayout__tabset_tabbar_outer {
  ...
  background-color: var(
    --sidebar
  ) !important; /* Ensure tab bar has sidebar bg */
  overflow: hidden;
  display: flex;
  font-size: inherit;
}
...
.flexlayout__tab_button {
  ...
  align-items: center;
  padding: 6px 10px;
  border: 1px solid transparent; /* Keep for spacing consistency */
  border-bottom: none;
  border-top-left-radius: var(--radius-md); /* Use medium for unselected */
...
/* Selected state specific to stretch buttons */
.flexlayout__tab_button_stretch.flexlayout__tab_button_stretch_top {
  background-color: var(--background);
  color: var(--foreground);
  font-weight: 500;
...
/* Add z-index to ensure content stays above the curves */
.flexlayout__tab_button_stretch.flexlayout__tab_button_stretch_top > * {
  position: relative;
  z-index: 2;
}
...
.flexlayout__tab_button:hover {
  /* background-color: var(--accent); */
  color: var(--accent-foreground);
  /* No border change on hover to keep curves clean */
  border-color: transparent;
  z-index: 3; /* Bring hover slightly forward */
}

/* --- CURVED TAB STYLES START (No Border Version) --- */
...
/* Base styles for pseudo-elements (curves) */
...
.flexlayout__tab_button_top.flexlayout__tab_button--selected::after {
  ...
  width: var(--tab-curve-size);
  height: var(--tab-curve-size);
  /* The mask creates the curve shape */
  mask-image: radial-gradient(
    circle at center,
    transparent calc(50% - var(--tab-border-width)),
    black calc(50% + var(--tab-border-width))
  ...
  mask-size: 200% 200%;
  pointer-events: none;
  /* Position elements AT the bottom edge (since no border to cover) */
  bottom: -2px;
  z-index: 1; /* Sit below tab content but above tab bar */
}

/* Left curve */
.flexlayout__tab_button_top.flexlayout__tab_button--selected::before {
  left: calc(
    -0.8 * var(--tab-curve-size)
  ) !important; /* Position outside the left edge */
  mask-position: 100% 100%; /* Use bottom-right mask quadrant for bottom-left curve shape */
}
...
.flexlayout__tab_button_top.flexlayout__tab_button--selected::after {
  right: calc(
    -0.8 * var(--tab-curve-size)
  ) !important; /* Position outside the right edge */
  mask-position: 0% 100%; /* Use bottom-left mask quadrant for bottom-right curve shape */
}

/* Ensure tab content (text, icons) is above the curves */
.flexlayout__tab_button_top.flexlayout__tab_button--selected
...
.flexlayout__tab_button_top.flexlayout__tab_button--selected
  ...
  z-index: 2; /* Ensure content is above ::before and ::after */
}
/* --- CURVED TAB STYLES END --- */
...
/* === Custom Overrides and Theming (Continued) === */

/* Tab Content Area */
.flexlayout__tab_content {
  background-color: var(--background);
  overflow: hidden;
  padding: 1rem; /* Or your desired padding */
  position: relative;
  z-index: 1;
  margin-top: 0;
}
...
/* === Dark Mode Overrides (No changes needed for curve logic itself) === */
...
.dark .flexlayout__tab_button:hover {
  background-color: var(--accent);
  color: var(--accent-foreground); /* NO BORDER */
}
